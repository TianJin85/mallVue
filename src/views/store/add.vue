<!--
 * @Author: your name
 * @Date: 2020-04-23 16:01:41
 * @LastEditTime: 2020-04-23 17:09:18
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \mallVue\src\views\store\add.vue
 -->
<template>
  <div class="container">
        ...
        <el-col :lg="16" :md="20" :sm="24" :xs="24">
          <el-form :model="form" status-icon ref="form" label-width="100px" @submit.native.prevent>
            ...
            <el-form-item label="商品详情" prop="detail">
              <div class="lin-wrap"><tinymce @change="detailChange" upload_url="http://dev.lin.colorful3.com/cms/file/" /></div>
            </el-form-item>
